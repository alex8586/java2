...
import lv.javaguru.java2.businesslogic.adminka.view_blocks.ProductViewBlock;
...
public class AdminPageDataServiceImpl implements AdminPageDataService {
    ...
    @Autowired
    ProductViewBlock productsBlock;
    ...
    public void init(HttpServletRequest request) {
       ...
       if(request.getParameter("view")!=null) {
           if (request.getParameter("view").equals("productEdit")) {

               productsBlock.setJspFile("product_edit.jsp");
           }
       }
    }
    ...
    public Map<String, Object> getDataAsMap()  {
        ...
        dataMap.put(PRODUCT_VIEW_NAME,productsBlock);
